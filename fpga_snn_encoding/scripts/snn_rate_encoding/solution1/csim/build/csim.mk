...
HLS_SOURCES = ../../../../../src/testbench_rate.cpp ../../../../../src/encoding.cpp
...
$(ObjDir)/testbench_rate.o: ../../../../../src/testbench_rate.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/testbench_rate.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_rate.d
