...
// 
// ==============================================================
#ifndef XRATE_ENCODING_H
#define XRATE_ENCODING_H
...
#ifndef __linux__
#define XRate_encoding_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XRate_encoding_ReadReg(BaseAddress, RegOffset) \
...
#else
int XRate_encoding_Initialize(XRate_encoding *InstancePtr, const char* InstanceName);
int XRate_encoding_Release(XRate_encoding *InstancePtr);
#endif
