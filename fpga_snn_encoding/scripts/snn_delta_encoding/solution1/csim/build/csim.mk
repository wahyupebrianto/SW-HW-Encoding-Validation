...
HLS_SOURCES = ../../../../../src/testbench_delta.cpp ../../../../../src/encoding.cpp
...
$(ObjDir)/testbench_delta.o: ../../../../../src/testbench_delta.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/testbench_delta.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_delta.d
