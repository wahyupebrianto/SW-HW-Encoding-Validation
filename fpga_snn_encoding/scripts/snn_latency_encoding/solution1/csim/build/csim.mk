...
HLS_SOURCES = ../../../../../src/testbench_latency.cpp ../../../../../src/encoding.cpp
...
$(ObjDir)/testbench_latency.o: ../../../../../src/testbench_latency.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/testbench_latency.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/testbench_latency.d

$(ObjDir)/encoding.o: ../../../../../src/encoding.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../../src/encoding.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/encoding.d
