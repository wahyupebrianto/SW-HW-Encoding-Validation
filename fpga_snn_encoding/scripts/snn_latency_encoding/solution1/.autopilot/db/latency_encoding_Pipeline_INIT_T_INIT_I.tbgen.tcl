set moduleName latency_encoding_Pipeline_INIT_T_INIT_I
set isTopModule 0
...
set C_modelName {latency_encoding_Pipeline_INIT_T_INIT_I}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "img","offset": { "type": "dynamic","port_name": "img","bundle": "control"},"direction": "READONLY"},{"cName": "spikes","offset": { "type": "dynamic","port_name": "spikes","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
...
set portList { 
	...
	{ spikes sc_in sc_lv 64 signal 1 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_5ns_11ns_15_1_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "19611", "Max" : "19611"}
	, {"Name" : "Interval", "Min" : "19611", "Max" : "19611"}
]}
