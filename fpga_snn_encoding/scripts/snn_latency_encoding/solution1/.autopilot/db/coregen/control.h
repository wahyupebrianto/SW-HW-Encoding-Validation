...
#define CONTROL_ADDR_IMG_DATA    0x10
#define CONTROL_BITS_IMG_DATA    64
#define CONTROL_ADDR_SPIKES_DATA 0x1c
#define CONTROL_BITS_SPIKES_DATA 64
#define CONTROL_ADDR_SEED_DATA   0x28
#define CONTROL_BITS_SEED_DATA   16
