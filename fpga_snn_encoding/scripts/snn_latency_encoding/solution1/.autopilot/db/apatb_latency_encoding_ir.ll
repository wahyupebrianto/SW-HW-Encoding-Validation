; ModuleID = 'E:/1_Research/Neuromorphic/NEUROMORPHIC/First_research/fpga_snn_encoding/scripts/snn_latency_encoding/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_latency_encoding_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="784" "maxi" %img, [784 x i8]* noalias nocapture nonnull "fpga.decayed.dim.hint"="25" "maxi" %spikes, i16 zeroext %seed) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_latency_encoding_hw([784 x float]* %img_copy, [25 x [784 x i8]]* %spikes_copy, i16 %seed)
...
declare void @apatb_latency_encoding_hw([784 x float]*, [25 x [784 x i8]]*, i16)
...
define void @latency_encoding_hw_stub_wrapper([784 x float]*, [25 x [784 x i8]]*, i16) #5 {
entry:
  call void @copy_out([784 x float]* null, [784 x float]* %0, [25 x [784 x i8]]* null, [25 x [784 x i8]]* %1)
  %3 = bitcast [784 x float]* %0 to float*
  %4 = bitcast [25 x [784 x i8]]* %1 to [784 x i8]*
  call void @latency_encoding_hw_stub(float* %3, [784 x i8]* %4, i16 %2)
  call void @copy_in([784 x float]* null, [784 x float]* %0, [25 x [784 x i8]]* null, [25 x [784 x i8]]* %1)
  ret void
}

declare void @latency_encoding_hw_stub(float* noalias nocapture nonnull readonly, [784 x i8]* noalias nocapture nonnull, i16 zeroext)
