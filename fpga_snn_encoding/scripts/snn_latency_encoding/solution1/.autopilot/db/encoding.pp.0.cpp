...
__attribute__((sdx_kernel("latency_encoding", 0))) void latency_encoding(
    pixel_t img[(28 * 28)],
    spike_t spikes[25][(28 * 28)],
    uint16_t seed
);
...
#line 54 "E:/1_Research/Neuromorphic/NEUROMORPHIC/First_research/fpga_snn_encoding/scripts/run_hls_encodingterpisah.tcl"
#pragma HLSDIRECTIVE TOP name=latency_encoding
# 74 "../src/encoding.cpp"
