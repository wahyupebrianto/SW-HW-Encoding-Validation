...
int main() {
    cout << "=======================================" << endl;
    cout << "RATE ENCODING TEST - 10K IMAGES" << endl;
    cout << "=======================================" << endl;
    ...
    cout << "\n=======================================" << endl;
    cout << "RATE ENCODING RESULTS" << endl;
    cout << "=======================================" << endl;
    printf("Sparsity:    %.2f%%\n", avg_sparsity);
    printf("Norm Rate:   %.4f\n", avg_norm);
    
    // Validation real results in software
    const float SW_SPARSITY = 86.75;
    const float SW_NORM = 0.1325;
    ...
    if (err_sp < 5.0f && err_nr < 0.02f) {
        cout << "\n✓ PASS - Consistent with software" << endl;
    } else {
        cout << "\n⚠ WARNING - Deviation detected" << endl;
    }
